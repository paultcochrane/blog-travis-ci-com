...
In the [Xcode 6 update postmortem](/2014-10-22-xcode-6-update-postportem/) we mentioned that we were going to start rolling out OS X environment in a more staged approach. Today we are making the new environment available as a beta.
